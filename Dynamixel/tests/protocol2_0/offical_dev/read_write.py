...
if MY_DXL == 'X_SERIES' or MY_DXL == 'MX_SERIES':       #  具体地址位与数值可以参考产品 eManual 电子手册
...
DXL_MOVING_STATUS_THRESHOLD = 20    # Dynamixel moving status threshold     运动状态阈值
...
while 1:
    ...
    # Write goal position
    if (MY_DXL == 'XL320'): # XL320 uses 2 byte Position Data, Check the size of data in your DYNAMIXEL's control table     特殊型号
